...
4. **LLM Controller**: Interfaces with the Ollama (Llama 3) model. It handles prompt construction, context injection, and parsing the LLM's response to extract citations.
